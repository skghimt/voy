 ...
 *
 * Project Name: xym
 * $Id:  StoryReplyService.java 2015-03-14 23:28:17 $
 */
...
public interface IStoryReplyService<D extends IBaseDAO<T>, T extends BaseDomain> extends IBaseService<D, T>,IPageService<D, T> {
