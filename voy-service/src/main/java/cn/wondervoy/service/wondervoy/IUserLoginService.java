 ...
 * $Id:  UserLoginService.java 2014-12-17 09:45:18 $
 */
...
public interface IUserLoginService<D extends IBaseDAO<T>, T extends BaseDomain> extends IBaseService<D, T>,IPageService<D, T> {
